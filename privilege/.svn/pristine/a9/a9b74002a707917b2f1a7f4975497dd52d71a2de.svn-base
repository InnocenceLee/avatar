...
(function() {
    ...
    var scriptEls = document.getElementsByTagName('script'),
        ...
        getQueryParam = window.getQueryParam = function(name) {
    ...
    document.write('<script type="text/javascript" src="' + path + '/ext-all' + (rtl ? '-rtl' : '') + (debug ? '-debug' : '') + '.jsx"></script>');
