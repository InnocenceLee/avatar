define('components/ms-search-item-select/ms-search-item-select', function(require, exports, module) {
  ...
  avalon.component('ms:searchItemSelect', {
      $slot: 'content',
      content: '',
      $template: "<div class=\"form-group\">\n    <label class=\"control-label\">{{label}}</label>\n    <select class=\"form-control\" ms-duplex=\"val\" ms-attr-name=\"col\">{{content|html}}</select>\n</div>",
      $replace: 1,
