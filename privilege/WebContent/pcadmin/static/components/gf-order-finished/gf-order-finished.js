define('components/gf-order-finished/gf-order-finished', function(require, exports, module) {
  ...
  var order = avalon.define({
      $id: 'gf-order-finished',
      '$data-box_config': {
          store: 'order-finished',
          actionBtns: {
