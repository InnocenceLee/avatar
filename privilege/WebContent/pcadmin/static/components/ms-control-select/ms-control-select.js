define('components/ms-control-select/ms-control-select', function(require, exports, module) {
  ...
  avalon.component('ms:controlSelect', {
      $slot: 'content',
      content: '',
      $template: "<div class=\"form-group\">\r\n    <label class=\"control-label\">{{label}}</label>\r\n    <select class=\"form-control\" ms-duplex=\"record[col]\" ms-attr-name=\"col\">{{content|html}}</select>\r\n</div>",
      $replace: 1,
