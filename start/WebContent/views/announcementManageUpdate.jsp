...
<body class="page-header-fixed" code="notify_query">
	...
	<div class="page-container">
		...
		<div class="page-content" id="myamaPage">
           ...
           <input type="hidden" id="notifyId" value="${param.id}">
		   ...
		   <div class="control-group" id="myammgroup">
           ...
           <p class="mybtnp2">
               ...
               <button class="btn blue myredbtn1" onclick="updateNotify();">确定</button>
          </p>
           <!-- 点击请选择触发的Modal -->
	...
	<script src="../js/notify/updateNotify.js"></script>
