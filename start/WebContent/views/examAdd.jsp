		...
		<div class="page-content myEapage">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                         考试管理 <i class="icon-angle-right"></i> 新建考试
                    </h3>
                    ...
                    <h4 class="media-heading">基本信息</h4>                   
                        <div class="control-group">
                            ...
                            <div class="controls mycontrols">
                                <input id="name" type="text" class="m-wrap large">
                            </div>
                        </div>
                        
                       <div class="control-group">
                            <label class="control-label myAllCondition">考试起止时间：</label>
                            <div class="controls mycontrols">
                                <input  id="examStart" type="text" class="m-wrap medium js-bt-datetimepicker" data-format="datetime">
                                <span class="myAllCondition" style="margin-left: 10px; margin-right: 30px;">至</span>
                                <input id="examEnd" type="text" class="m-wrap medium js-bt-datetimepicker" data-format="datetime">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls mycontrols">
                                <select id="examClassifications" class="medium m-wrap" tabindex="1" style="width: 524px !important;">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls mycontrols">
                                <select id="examType" class="large m-wrap" tabindex="1" style="width: 524px !important;">
                        ...
                        <div class="control-group myScoreContro" style="margin-left: 20px !important;">
                            ...
                            <div class="controls mycontrols" style="position:relative;">
                                <input id="passScore" type="text" class="m-wrap medium" style="width: 55px !important;" >
                        ...
                        <div class="control-group myScoreContro2" style="margin-left: 20px !important;">
                            ...
                            <div class="controls mycontrols" style="position:relative;">
                                <input id="exmaNum" type="text" class="m-wrap medium" style="width: 55px !important;">
                        ...
                        <div class="control-group myScoreContro2" style="margin-left: 20px !important;">
                            ...
                            <div class="controls mycontrols" style="position:relative;">
                                <input id="examDuration" type="text" class="m-wrap medium" style="width: 55px !important;" value="60">
                                <span class="help-block myVerification" style="top:0px;left:77px;width:40px;" >分钟</span>
                            </div>                       
                        </div>                                        	
                        
                            <!-- <label class="control-label myEaLable1">考试时长：</label>
                            <div class="controls mycontrols">
								<input id="examDuration" type="text" class="m-wrap medium myEamedium">分钟
                            </div> -->
                        
                        <div class="control-group myNotice">
                            <label class="control-label myEaLable1">考试须知：</label>
                            <div class="controls mycontrols">
                                <textarea id="examNotice" class="large m-wrap" rows="5"></textarea>
                            </div>
                        </div>                   
                    <!-- END FORM-->             
                </div>
                ...
                <div class="control-group" id="myEagroup1">
                      <p class="mybtnp1">
                           ...
                           <button class="btn red myredbtn1" onclick="delNotifyPerson()">批量删除</button>
                            <button  class="btn myEabtn1" id="myGroupbtn1" data-toggle="modal" data-target="#myGroupingModal">保存到分组</button>
           	         </p>
                </div>               	
            <!-- END PAGE HEADER-->
...
<!--                                 <tr class="odd gradeX">
                ...
                <!--    发送方式选择 -->
                           <div class="control-group">													
				            ...
				            <p class="mybtnp2">
				                           ...
				                           <button class="btn red myredbtn1" onclick="window.location.href='examList.jsp'">退出</button>
				           	 </p>
           	                <!-- 点击选择试卷触发的Modal -->						   
						            ...
						            <div class="modal-content">
						                ...
						                <span>试卷名称：</span>
						                 <input class="m-wrap" size="16" type="text" value="" id="searchExamPaperName"/>
                                          <button id="myeamodalbtn" class="btn blue mysearchbtn1 myredbtn1" onclick="searchPaper()">搜索</button>
                                          <div class="row-fluid">
                                            <div class="span12">
                                           <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                               <div class="portlet box light-grey">
  ...
  <!--                                                               <tr class="odd gradeX">
	...
	<script src="../js/exam/examAdd.js"></script>
