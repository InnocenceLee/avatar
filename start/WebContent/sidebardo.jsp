			...
			String createSysFunLink(Map fun , int level,HttpServletRequest request){
				...
				if (level == 1) {
                    ...
                    if((fun.get("open_mode")).equals("W") || (fun.get("open_mode")).equals("w")){
                        ...
                        return "<a href='"+request.getContextPath()+"front/main.jssp?fun="+fun.get("code")+"' data-molecule='true' fun-uri='" + fun.get("uri") + "' fun-code='" + fun.get("code") + "'>" + fun_name  + "</a>";
                    } else if(((fun.get("open_mode")).equals("P"))){
//                     	return String.format("<a href=\"%s%s\"> ", request.getContextPath(),fun.get("uri"));
						String uri = fun.get("uri").toString();
                    	return "<a href='"+ request.getContextPath()+ uri+"'><span class='title'>"+fun_name+"</span></a>";// Modal 
                    }else{
                    	return "";
                    }
			}
