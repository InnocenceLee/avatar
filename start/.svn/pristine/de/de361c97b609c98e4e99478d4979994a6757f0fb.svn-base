...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<!-- BEGIN PAGE CONTAINER-->
			<!-- -------------------------------从这里开始 ------------------------------------------------------ -->
			<div class="page-content" id="myEqaPage">
				...
				<form action="#" class="form-horizontal form-row-seperated">
					<div class="control-group">
						...
						<label class="control-label mycontrol-label1">关键字:</label>
						<div class="controls">

							<input class="m-wrap mywrap mycondition" size="16" type="text" value="" id="ui_date_picker"/>
				 ...
				 <h4 class="media-heading">题目列表</h4>
				     <label class="checkbox myeqacheckbox">
				 ...
				 <div class="portlet box yellow">
						...
						<button type="button" id="mysure" class="btn red">确定</button>
		</div>
		</div>
