...
(function() {
    ...
    function oa(a, b, c) {
        ...
        f;
        if (typeof b == "string") if (S(c)) a[e](b, c);
        else {
    ...
    function gd(a) {
        function b(l, h) {
            ...
            function E(k, p, s, y, B, G, I) {
                ...
                y && L.path(L.crispLine([ib, p, ca, Na, pb, Z], y)).attr({
                    stroke: s,
                    "stroke-width": y
                }).add(r);
            ...
            function ka(k, p) {
                ...
                if (!p) {
                    p = [1, 2, 2.5, 5, 10];
                    if (h.allowDecimals === false) if (tb == 1) p = [1, 2, 5, 10];
                    else if (tb <= 0.1) p = [1 / tb]
                }
            ...
            function ua() {
                ...
                ca = 2592E6 / ab,
                pb = 31556952E3 / ab,
                Z = [["second", s, [1, 2, 5, 10, 15, 30]], ["minute", y, [1, 2, 5, 10, 15, 30]], ["hour", B, [1, 2, 3, 4, 6, 8, 12]], ["day", G, [1, 2]], ["week", I, [1, 2]], ["month", ca, [1, 2, 3, 4, 6]], ["year", pb, null]],
                Ta = Z[6],
                ea = Ta[1],
                V = Ta[2];
                ...
                if (ea >= B) V[Oc](ea >= G ? 0 : Z * jb(V[sc]() / Z));
                ...
                for (B = V[Rb](); s < U && k < wa;) {
                    ba.push(s);
                    if (ea == pb) s = $b(ub + k * Z, 0) / ab;
                    else if (ea == ca) s = $b(ub, y + k * Z) / ab;
                    else if (!p && (ea == G || ea == I)) s = $b(ub, y, B + k * Z * (ea == G ? 1 : 7));
                    else s += ea * Z;
                    k++
                }
                ba.push(s);
            ...
            function bb() {
                ...
                if (!kb && ba.length > Nb[nb]) Nb[nb] = ba.length;
            ...
            function x() {
                ...
                if (B) {
                    ...
                    function(I, ca) {
                        ...
                        E(I, h.tickPosition, h.tickColor, h.tickWidth, h.tickLength, !(I == N && !h.showFirstLabel || I == U && !h.showLastLabel), ca)
                    });
                    q(xc,
                    function(I) {
                ...
                if (!l.hasRendered) {
                    ...
                    if (!aa.axisTitle && k && k.text) {
                        ...
                        s = (T ? ja + pa: Y) + (T ? 1 : -1) * (da ? -1 : 1) * k.margin - (Lc ? parseInt(k.style.fontSize || 12, 10) / 3 : 0);
            ...
            ba,
            Mb,
            gc = h.labels.formatter,
            Oa = h.categories || Q && l.columnCount,
            zb = h.reversed,
            Cb = Oa && h.tickmarkPlacement == "between" ? 0.5 : 0;
        ...
        function c() {
            function l(v, D, J, E) {
                if (!t[v]) {
                    D = L.text(D, Y + wa - 20, ja + 30, a.toolbar.itemStyle, 0, "right").on("click", E).attr({
                        zIndex: 20
                    }).add();
                    t[v] = D
                }
        ...
        function d(l) {
            ...
            function v(X) {
                var x = X.series,
                u = l.borderColor || X.color || x.color || "#606060",
                C, R;
                R = X.tooltipText;
                C = X.tooltipPos;
                D = x;
                ...
                if (R === false || !C) t();
                    ...
                    if (x < 5) x = 5;
                    else if (x + xa > Aa) x = Aa - xa - 5;
                    h(W(u - ua), W(x - ua))
                }
            }
            var D, J = l.borderWidth,
            E = l.style,
            ka = parseInt(E.padding, 10),
            ua = J + ka,
            fa = true,
            Ea,
            xa,
            ...
            bb = 0;
            E.padding = 0;
            var Ga = L.g("tooltip").attr({
                zIndex: 8
            }).add(),
            Va = L.rect(ua, ua, 0, 0, l.borderRadius, J).attr({
                fill: l.backgroundColor,
                "stroke-width": J
            }).add(Ga).shadow(l.shadow),
            qb = L.text("", ka + ua, parseInt(E.fontSize, 10) + ka + ua).attr({
                zIndex: 1
            }).css(E).add(Ga);
            return {
                refresh: v,
        ...
        function e(l, h) {
            ...
            function D(x) {
                var u = l.hoverPoint,
                C = l.hoverSeries;
                if (C && C.tracker)(x = C.tooltipPoints[ma ? x.pageY - lb.y: x.pageX - lb.x - Y]) && x != u && x.onMouseOver()
            }
            function J() {
                var x = l.hoverSeries,
                u = l.hoverPoint;
                ...
                if (ya) {
                    ...
                    if (xa) {
                        ...
                        function(Q) {
                            ...
                            T = Q.isXAxis,
                            $a = ma ? !T: T,
                            aa = da($a ? C: pa - R - u.height, true);
                            da = da($a ? C + u.width: pa - R, true);
                            x[T ? "xAxis": "yAxis"].push({
                                axis: Q,
                                min: Lb(aa, da),
                                max: sb(aa, da)
                            })
            ...
            function ka() {
                ...
                Ha.onclick = function(u) {
                    ...
                    if (!xa) if (C && oa(u.target, "isTracker")) {
                        ...
                        Q = C.plotY;
                        O(C, {
                            pageX: lb.x + Y + (ma ? wa - Q: R),
                            pageY: lb.y + ja + (ma ? pa - R: Q)
                        });
                        za(l.hoverSeries, "click", O(u, {
                            point: C
                        }));
        ...
        function f(l) {
            var h = l.type || H.defaultSeriesType,
            t = eb[h],
            v = w.hasRendered;
            if (v) if (ma && h == "column") t = eb.bar;
            else if (!ma && h == "bar") t = eb.column;
            h = new t;
            h.init(w, l);
        ...
        function ha() {
           ...
           /* if (!w.titleLayer) {
                l && l.text && L.text(l.text, D[h] + l.x, l.y, l.style, 0, h).attr({
                    "class": "highcharts-title"
                }).add();
                t && t.text && L.text(t.text, D[v] + t.x, t.y, t.style, 0, v).attr({
        ...
        function Hb() {
            ...
            h.items && q(h.items,
            function() {
                var ka = O(h.style, this.style),
                ua = parseInt(ka.left, 10) + Y,
                fa = parseInt(ka.top, 10) + ja + 12;
                delete ka.left;
                delete ka.top;
                L.text(this.html, ua, fa, ka).attr({
                    zIndex: 2
                }).add()
            });
            q(ta,
            ...
            if (!w.toolbar) w.toolbar = c(w);
            t.enabled && !w.credits && L.text(t.text, Ma - 10, Aa - 5, t.style, 0, "right").on("click",
            function() {
        ...
        var ja = A(H.marginTop, Ja[0]),
        vc = A(H.marginRight, Ja[1]),
        Bb = A(H.marginBottom, Ja[2]),
        Y = A(H.marginLeft, Ja[3]),
        mb,
        vb,
        Ha,
        Hc,
        ...
        w = this;
        Ja = H.events;
        var Xb, Jc, Tb, Cc, Ec, Db, pa, wa, Ob, Fc, Gc, lb, jc = H.showAxes,
        Qa = [],
        Nb,
        ta = [],
        ma,
        ...
        ld = function(l) {
            ...
            function D(r) {
                ...
                if (!K) {
                    ...
                    r.legendItem = K = L.text(E.labelFormatter.call(r), 0, 0, ya).on("mouseover",
                    function() {
                        r.setState(ob);
                        K.css(bb)
                    }).on("mouseout",
                    ...
                    if (F) M = L.rect( - ua - fa, -11, ua, 12, 2).attr({
                        "stroke-width": 0,
                        zIndex: 3
                    }).add(aa);
                    else if (r.options && r.options.marker && r.options.marker.enabled) M = L.symbol(r.symbol, -ua / 2 - fa, -4, r.options.marker.radius).attr(r.pointAttr[Ka]).attr({
                        zIndex: 3
                    }).add(aa);
                    r.legendSymbol = M;
                    h(r, r.visible);
            ...
            function J() {
                ...
                if (T || $a) {
                    ...
                    else da = L.rect(0, 0, nb, La, E.borderRadius, T || 0).attr({
                ...
                function(P) {
                    var Ba = P.checkbox;
                    Ba && Sa(Ba, {
                        left: K.x + P.legendItemWidth + Ba.x - 40 + Ia,
                        top: K.y + Ba.y - 11 + Ia
                    })
                })
            }
            ...
            if (E.enabled) {
                ...
                ya = E.itemStyle,
                bb = E.itemHoverStyle,
                Ga = E.itemHiddenStyle,
                Va = parseInt(xa.padding, 10),
                qb = 20,
                X = E.lineHeight || 16,
                x = 18,
                u = 4 + Va + ua + fa,
        ...
        Dc = function(l) {
            var h = sa.lang;
            w.toolbar.add("zoom", h.resetZoom, h.resetZoomTitle, $c); ! l || l.resetSelection ? q(Qa,
            function(t) {
                t.setExtremes(null, null, false)
            }) : q(l.xAxis.concat(l.yAxis),
            function(t) {
                var v = t.axis;
        ...
        Jc = function(l) {
            ...
            if (/^(right|center)$/.test(h)) J.x = (Ma - l.width) / {
                right: 1,
                center: 2
            } [h] + v;
            if (/^(bottom|middle)$/.test(t)) J.y = (Aa - l.height) / {
                bottom: 1,
                middle: 2
            } [t] + D;
            return J
    ...
    Lc = /msie/i.test(qa) && !db.opera,
    md = /AppleWebKit/.test(qa),
    bd = db.SVGAngle || la.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"),
    rb,
    lc,
    nd = {},
    Ic = 0,
    ...
    if (!Ca && db.jQuery) {
        ...
        ia = function() {
            var a = arguments;
            return Xa.extend(true, null, a[0], a[1], a[2], a[3])
        };
        qc = function(a) {
        ...
        var od = jQuery.fx.step._default,
        pd = jQuery.fx.prototype.cur;
    ...
    ec.prototype = {
        ...
        add: function(a) {
            var b = a ? a.element: this.renderer.box,
            c = b.childNodes,
            d = this.element,
            e = oa(d, "zIndex"),
            f,
        ...
        destroy: function() {
            ...
            d && d.removeChild(b);
            c && q(c,
            function(f) { (d = f.parentNode) && d.removeChild(f)
            });
    ...
    Wb.prototype = {
        ...
        buildText: function(a, b) {
            b = b.toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split("<br/>");
            var c = a.childNodes,
            d = /style="([ 0-9a-z:;\-]+)"/,
            e = /href="([^"]+)"/,
            f = oa(a, "x"),
            ...
            function(j, i) {
                ...
                function(o) {
                    if (o !== "") {
                        var n = {},
                        z = la.createElementNS("http://www.w3.org/2000/svg", "tspan");
                        d.test(o) && oa(z, "style", o.match(d)[1].replace(/(;| |^)color([ :])/, "$1fill$2"));
                        if (e.test(o)) {
        ...
        rect: function(a, b, c, d, e, f) {
            ...
            return this.createElement("rect").attr(O(g, {
                rx: e || g.r,
                ry: e || g.r,
                fill: fb
            }))
    ...
    if (!bd) {
        var qd = gb(ec, {
            ...
            attr: function(a, b) {
                ...
                if (typeof a == "string") {
                    c = a;
                    na = c == "strokeWidth" ? f.strokeweight: A(this[c], parseInt(g[{
                        x: "left",
                        y: "top"
                    } [c] || c], 10))
                } else for (c in a) {
                    ...
                    if (n && c == "visibility") for (e = n.length; e--;) n[e].style[c] = d;
                    if (c == "text") f.innerHTML = d;
                    else if (!z) if (la.documentMode == 8) f[c] = d;
                    else oa(f, c, d)
                }
                return na
            },
        ...
        Kc.prototype = ia(Wb.prototype, {
            ...
            color: function(a, b, c) {
                ...
                if (a && a.linearGradient) {
                    ...
                    a = ['<fill colors="0% ', j, ",100% ", m, '" angle="', a, '" opacity="', o, '" o:opacity2="', i, '" type="gradient" focus="100%" />'];
    ...
    Zb.prototype = {
        ...
        importEvents: function() {
            if (!this.hasImportedEvents) {
                var a = this,
                b = ia(a.series.options.point, a.options);
                b = b.events;
                var c;
                a.events = b;
    ...
    Ra.prototype = {
        ...
        getSymbol: function() {
            ...
            b = this.options.marker.symbol || a[lc++];
            this.symbol = b;
            if (lc >= a.length) lc = 0
        },
        ...
        translate: function() {
            for (var a = this,
            b = a.chart,
            c = a.options.stacking,
            d = a.xAxis.categories,
            e = a.yAxis,
            f = e.stacks[a.type], g = a.data, j = g.length; j--;) {
                var i = g[j],
                m = i.x,
                o = i.y,
                n;
        ...
        destroy: function() {
            ...
            q(["area", "graph", "dataLabelsGroup", "group", "tracker"],
            function(e) {
                a[e] && a[e].destroy()
            });
        ...
        drawDataLabels: function() {
            if (this.options.dataLabels.enabled) {
                ...
                o;
                if (g) g.empty();
                else g = a.dataLabelsGroup = j.renderer.g(Fb + "data-labels").attr({
                    visibility: a.visible ? Yb: Gb,
                    zIndex: 4
                }).translate(j.plotLeft, j.plotTop).add();
                e.style.color = A(e.color, a.color);
                q(d,
                function(n) {
                    var z = A(n.barX, n.plotX),
                    na = n.plotY,
                    ga = n.tooltipPos;
                    f = e.formatter.call({
                        x: n.x,
                    ...
                    if (f) n.dataLabel = j.renderer.text(f, b, c, e.style, e.rotation, o).attr({
                        zIndex: 1
                    }).add(n.group || g);
        ...
        drawGraph: function() {
            ...
            m;
            c = c.renderer;
            var o = a.yAxis.getZeroPlane(b.threshold || 0),
            n = [];
            q(a.segments,
            function(z) {
                m = [];
                ...
                if (/^area/.test(a.type)) {
                    ...
                    if (b.stacking && a.type != "areaspline") for (ga = z.length - 1; ga >= 0; ga--) na.push(z[ga].plotX, z[ga].yBottom);
                    else na.push(z[z.length - 1].plotX, o, z[0].plotX, o, "z");
                    n = n.concat(na)
                }
            });
            ...
            else if (i) a.graph = c.path(e).attr({
                stroke: j,
                "stroke-width": i + Ia
            ...
            if (n.length) {
                ...
                else a.area = a.chart.renderer.path(n).attr({
                    fill: d
                }).add(a.group)
            }
        },
        ...
        setVisible: function(a, b) {
            ...
            j = c.dataLabelsGroup,
            i, m = c.data,
            o = d.options.chart.ignoreHiddenSeries;
            i = c.visible;
            i = (c.visible = a = a === Ya ? !i: a) ? "show": "hide";
            if (a) c.isDirty = o;
            f && f[i]();
            if (g) g[i]();
            else for (f = m.length; f--;) {
                g = m[f];
                g.tracker && g.tracker[i]()
            }
            j && j[i]();
            e && d.legend.colorizeItem(c, a);
            o && c.options.stacking && q(d.series,
            function(n) {
    ...
    qa = gb(Ra, {
        ...
        getSplineData: function() {
            ...
            function(e) {
                ...
                if (f.length > 1) d = W(sb(b.plotWidth, f[f.length - 1].clientX - f[0].clientX) / 3);
    ...
    var nc = gb(Ra, {
        ...
        translate: function() {
            ...
            i = i / c;
            var m = g.pointWidth,
            o = S(m) ? (i - m) / 2 : i * g.pointPadding,
            n = A(m, i - 2 * o);
            m = (d ? c - a.columnIndex: a.columnIndex) || 0;
            var z = o + (e + m * i - b / 2) * (d ? -1 : 1),
            na = a.yAxis.getZeroPlane(g.threshold || 0),
            ga = g.minPointLength;
            q(j,
            function(va) {
                var ha = va.plotY,
                ...
                if (S(H)) va.trackerArgs = ia(va.shapeArgs, {
                    height: 6,
                    y: H
                })
            })
        ...
        drawPoints: function() {
            ...
            function(f) {
                if (S(f.plotY)) {
                    ...
                    e = f.shapeArgs;
                    if (d) d.attr(e);
                    else f.graphic = c[f.shapeType](e).attr(f.pointAttr[f.selected ? xb: Ka]).add(a.group).shadow(b.shadow)
                }
            })
        },
        drawTracker: function() {
    ...
    qa = gb(Ra, {
        ...
        drawPoints: function() {
            ...
            function(g) {
                ...
                if (e) e.attr(f);
                else g.graphic = c.arc(f).attr(g.pointAttr[Ka]).add(g.group);
                g.visible === false && g.setVisible(false)
            })
        },
        drawTracker: nc.prototype.drawTracker,
        getSymbol: function() {}
    });
    eb.pie = qa;
    db.Highcharts = {
